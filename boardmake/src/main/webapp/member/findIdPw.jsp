...
<title>Insert title here</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
   ...
   <link rel="stylesheet" href="/boardmake/css/bootstrap.css" />
   <style>
      body{
         padding-top:20px;
      }
 ...
 <ul class="nav nav-tabs" id="myTab" role="tablist">
  ...
  <div class="tab-content" id="myTabContent">
      <div class="tab-pane fade show active" id="id" role="tabpanel" aria-labelledby="id-tab">
          <form class="findIdform" action="/boardmake/FindIdPw" method="post">
              <div class="mb-2 px-5">
...
<footer class="text-center">
   <a href="index.jsp">Copyright &copy; 4567dx all right reserved.</a>
</footer>    
<script src="/boardmake/js/popper.min.js"></script>
<script src="/boardmake/js/bootstrap.js"></script>
<script src="/boardmake/js/script.js"></script>
</body>
</html>