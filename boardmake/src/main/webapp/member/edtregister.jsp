...
<div id="logreg-forms">
	<form action="/boardmake/MemUpdate" class="form-signup" method="post"
		name="edtregisterform">
		...
		<div class="form-group">
			<label for="userid">User ID:</label><br> <input type="text"
				class="form-control" id="userid" name="userid" value="${dto.userid}"
		...
		<div class="form-group">
			<label for="userpass">Password:</label> <input type="password"
				class="form-control" id="userpass" name="userpass" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="postcode">Postcode:</label><br> <input type="text"
				...
				value="${dto.postcode}"> <input type="button"
				class="btn btn-primary" onclick="sample6_execDaumPostcode()"
				value="우편번호 찾기">
		</div>
		<div class="form-group">
			<label for="addr">Address:</label> <input type="text"
				class="form-control" id="addr" name="addr" value="${dto.addr}">
		</div>
		<div class="form-group">
			<label for="detailaddr">Detail Address:</label> <input type="text"
				class="form-control" id="detailaddr" name="detailaddr"
				value="${dto.detailaddr}">
		</div>
		<div class="form-group">
			<label for="extraaddr">Extra Address:</label> <input type="text"
				class="form-control" id="extraaddr" name="extraaddr">
		</div>
		<div class="form-group">
			<label for="tel">Phone:</label> <input type="text"
				class="form-control" id="tel" name="tel" placeholder="01000000000"
				value="${dto.tel}">
		</div>
		...
		<button type="button" class="btn btn-success btn-block"
			onclick="register2();">
			<i class="fas fa-user-plus"></i> 정보 수정
		</button>
		<a href="index.jsp" id="cancel_signup"><i
