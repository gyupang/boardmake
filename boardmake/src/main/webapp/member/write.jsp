...
<form action="WriteProcess" method="post" onsubmit="return validateForm(this);">
 ...
 <div class="form-floating">
  <textarea class="form-control" name="content" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 200px"></textarea>
  <label for="floatingTextarea2">내용</label>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <button type="button" class="btn btn-outline-primary" onclick="location.href='?fname=freeBoard';">목록 보기</button>
            </td>
        </tr>
    </table>
